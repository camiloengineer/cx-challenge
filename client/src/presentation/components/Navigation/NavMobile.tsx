...
import ButtonClose from "presentation/components/ButtonClose/ButtonClose";
import Logo from "presentation/components/Logo/Logo";
import { Disclosure } from "@headlessui/react";
import { NavLink } from "react-router-dom";
import { NavItemType } from "./NavigationItem";
import { NAVIGATION_DEMO_2 } from "infrastructure/data/navigation";
import SocialsList from "presentation/components/SocialsList/SocialsList";
import { ChevronDownIcon } from "@heroicons/react/24/solid";
import SwitchDarkMode from "presentation/components/SwitchDarkMode/SwitchDarkMode";
      ...
      <div className="py-6 px-5">
        ...
        <div className="flex flex-col mt-5 text-slate-600 dark:text-slate-300 text-sm">
          <span>
            ...
            vida. Escribe tus historias y compártelas.
          </span>

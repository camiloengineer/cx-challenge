...
import Avatar from "presentation/shared/Avatar/Avatar";
import SwitchDarkMode2 from "presentation/shared/SwitchDarkMode/SwitchDarkMode2";
          ...
          <>
            ...
            >
              <Avatar
                ...
                hasChecked={user.userRestrictions?.length > 0 ? false : true}
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      <Avatar
                        imgUrl={user.profileImage}
                        hasChecked={
                          user.userRestrictions?.length > 0 ? false : true
                        }
                        userName={`${user.name} ${user.surname}`}
                        sizeClass="w-12 h-12"
                      />
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-xs mt-0.5 capitalize">
                          {user.levelDetail?.description}
                        </p>
                      </div>
                    </div>
                    {user.userRestrictions?.map((restriction, index) => (
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"Mis compras"}</p>
                      </div>
                    </Link>

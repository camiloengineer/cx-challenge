...
import imageRightPng from "application/images/hero-right.png";
import imageRightPng2 from "application/images/hero-right-2.png";
import imageRightPng3 from "application/images/hero-right-3.png";

import backgroundLineSvg from "application/images/Moon.svg";
import ButtonPrimary from "application/components/Button/ButtonPrimary";
import Next from "application/components/NextPrev/Next";
import Prev from "application/components/NextPrev/Prev";
...
const DATA: Hero2DataType[] = [
  {
    ...
    heading: "Colección exclusiva para todos",
    subHeading: "En esta temporada, encuentra lo mejor 🔥",
